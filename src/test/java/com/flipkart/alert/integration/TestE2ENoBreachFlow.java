...
import com.flipkart.alert.storage.GraphiteHttpClient;
...
*/
public class TestE2ENoBreachFlow extends BaseIntegrationTest {
...
//    @Test(groups = {"smoke","regression","e2e"})
    public void e2e() throws IOException, InterruptedException {
        // Create Rule
        ScheduledRule rule = scheduledRuleClient.createRule("fixtures/rule.e2e.nobreach.json");
